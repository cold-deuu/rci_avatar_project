...
void SE3CubicTrajectory::SetCurrentTime(rclcpp::Time ctime){
    m_ctime = ctime;
}

void SE3CubicTrajectory::SetStartTime(rclcpp::Time stime){
    m_stime = stime;
}

void SE3CubicTrajectory::SetDuration(rclcpp::Duration duration){
    m_duration = duration;
}
